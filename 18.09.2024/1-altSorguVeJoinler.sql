...
--Aksi takdirde, PostgreSQL sütun ve tablo adlarını otomatik olarak küçük harfe çevirir(fakulteid gibi) 
--ve sütun bulunamazsa hata verir.

--Kodda "fakulteId" sütunu çift tırnak içinde yazıldığı için, bu sütun adı büyük/küçük harfe duyarlıdır 
--ve veritabanında tam olarak "fakulteId" olarak tanımlanmıştır.
--Eğer çift tırnak kullanılmasaydı, PostgreSQL bu sütun adını otomatik olarak küçük harfe dönüştürerek fakulteid olarak yorumlardı.
